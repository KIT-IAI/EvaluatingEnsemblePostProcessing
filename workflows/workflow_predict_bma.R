...
workflow_predict <- function(ensemble_name,
  ...
  source("~/Work/Gits/ensemble_post_processing/calibration/bma_weather_parameters.R")
  
  
  emos_weather <- bma_weather_variables(original_ensembles = structured_data,
                                         weather_params = weather_params,
                                         norm_l = norm_l,
                                         gamma_l = gamma_l,
                                         horizons = horizons,
  ...
  emos_weather_distribution <- bma_weather_dist_parameters(bma_params = emos_weather,
  ...
  emos_draw_weather <- bma_weather_forecast(bma_params = emos_weather,
                                             weather_ensembles = structured_data,
                                             weather_params = weather_params,
                                             norm_l = norm_l,
                                             gamma_l = gamma_l,
