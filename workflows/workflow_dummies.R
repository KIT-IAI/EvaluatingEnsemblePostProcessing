...
workflow_dummies <- function(ensemble_name,
  ...
  if(linearModel) { 
    if(standardLinear) {
      source("~/Work/Gits/ensemble_post_processing/forecasting/train_dummy_linear_model.R")
      ...
      source("~/Work/Gits/ensemble_post_processing/forecasting/train_alternative_dummy_linear_model.R")
