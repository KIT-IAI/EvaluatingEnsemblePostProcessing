...
workflow_combined_bma <- function(ensemble_name,
                                      control_name,
                                      obs_name,
                                      power_name,
                                      file_path,
  ...
  power_emos_emos <- bma_power_ensembles(power_ensembles = emos_prediction,
                                          horizons = horizons,
                                          daysToTrain = emosDaysToTrain)
  message("BMA Power Calibration Complete")
  
  
  power_emos_emos_dist <- bma_power_distribution(bma_params = power_emos_emos,
  ...
  cal_emos_prediction <- bma_power_forecast(bma_params = power_emos_emos,
                                             power_ensembles = emos_prediction,
                                             horizons = horizons,
                                             daysToTrain = emosDaysToTrain)
