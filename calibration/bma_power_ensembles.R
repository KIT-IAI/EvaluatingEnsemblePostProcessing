...
bma_power_ensembles <- function(power_ensembles, horizons, daysToTrain = 30, startDate = NULL) {
  require(dplyr)
...
bma_power_forecast <- function(bma_params, power_ensembles, horizons, daysToTrain = 30, startDate = NULL) {
  require(crch)
  require(scoringRules)
  #Create ensemble member names
  ensMemberNames <- 0
...
bma_power_distribution <- function(bma_params, power_ensembles, horizons, daysToTrain = 30, startDate = NULL) {
  require(crch)
  require(scoringRules)
  #Create ensemble member names
  ensMemberNames <- 0
